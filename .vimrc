...
" one tab is displayed with the length of 4 columns
set tabstop=4 
" indent width
set shiftwidth=4
" do not expand tab into spaces
set noexpandtab
" setting softtabstop to 0 because real men never use mixed tab and
" spaces for indentation!
set softtabstop=0

"the above four set commands may not work for some file type because 
"they are overriden, consider using after dirctory this time
